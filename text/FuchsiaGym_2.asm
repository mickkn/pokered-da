_FuchsiaGymKogaPostBattleAdviceText::
	...
	cont "#MON mere og"
	cont "mere som kampen"
	cont "skrider frem!"

	para "Det vil helt"
	line "sikkert skræmme"
	cont "fjenderne!"
	done
